...
{ 
  ...
  { 
    ...
    java.util.ArrayList<String> list115 = new java.util.ArrayList<String>(messages3);
    inForLoop = true;
    forLoopCounter++;
    int limit80 = 1000;
    int offset80 = 0;
    int removedcount80 = 0;
    Object[] array172 = list115.toArray();
    for(int i172 = 0; i172 < array172.length; i172++)
    { 
      String ve3 = (String)array172[i172];
      if(limit80 <= 0)
      { 
        list115.remove(i172 - removedcount80);
        removedcount80++;
      }
      limit80--;
    }
    int separatorindex80 = 0;
    Object[] array173 = list115.toArray();
    ...
    { 
      ...
      try
      { 
        tmpstring177 = ThreadLocalPage.get().isRawoutput() ? String.valueOf(ve3) : utils.HTMLFilter.filter(String.valueOf(ve3));
      }
      catch(NullPointerException npe)
      { 
        tmpstring177 = "";
      }
      out.print(tmpstring177);
