...
public class signup_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        initialized = true;
        this.env = env;
        env.putTemplate("body", signup_body_Template.class);
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("signup_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "signup()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "signup()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    ident += "tcall14";
    ThreadLocalPage.get().enterTemplateContext("tcall14");
    try
    { 
      Object[] args109 = {};
      Object[] args108 = {};
      ...
      { 
        ...
        ((TemplateServlet)templatecalls.get(ident)).validateInputs(args109, new Environment(env), new utils.TemplateCall("none", args108), withcallsmapout, attrsmapout);
      }
    ...
    ident = "";
    ThreadLocalPage.get().leaveTemplateContextChecked("tcall14");
  }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).render(args115, new Environment(env), new utils.TemplateCall("none", args114), withcallsmapout, attrsmapout, out);
      }
      catch(NullPointerException npe)
      { }
    }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).handleActions(args113, new Environment(env), new utils.TemplateCall("none", args112), withcallsmapout, attrsmapout, out);
  ...
  { 
    exampleapp.domain.User objCr13 = new exampleapp.domain.User().setupForPropertyEvents(hibSession, out);
    objCr13.User_(hibSession, env, out);
    user0 = objCr13;
    password3 = "";
  }
  ...
  { 
    env.putVariable("user0", user0);
    env.putVariable("password3", password3);
  }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).storeInputs(args111, new Environment(env), new utils.TemplateCall("none", args110), withcallsmapout, attrsmapout);
      }
      catch(NullPointerException npe)
      { }
    }
