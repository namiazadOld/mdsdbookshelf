...
public class editPerson_Template  implements TemplateServlet
{ 
  private void storeArguments(Object[] args)
  { 
    arg13 = (exampleapp.domain.Person)args[0];
  }
  ...
  { 
    ...
    { 
      ...
      { 
        initialized = true;
        this.env = env;
        env.putTemplate("body", editPerson_body_Template.class);
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("editPerson_Template", "" + (arg13 != null ? arg13.getVersion() == 0 ? "_" : arg13.getId().toString() : "null"), ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "editPerson(arg : Person)" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "editPerson(arg : Person)" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  private exampleapp.domain.Person arg13 = null;
  ...
  { 
    ...
    ident += "tcall3";
    ThreadLocalPage.get().enterTemplateContext("tcall3");
    try
    { 
      Object[] args23 = {};
      Object[] args22 = {};
      ...
      { 
        ...
        ((TemplateServlet)templatecalls.get(ident)).validateInputs(args23, new Environment(env), new utils.TemplateCall("none", args22), withcallsmapout, attrsmapout);
      }
    ...
    ident = "";
    ThreadLocalPage.get().leaveTemplateContextChecked("tcall3");
  }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).render(args29, new Environment(env), new utils.TemplateCall("none", args28), withcallsmapout, attrsmapout, out);
      }
      catch(NullPointerException npe)
      { }
    }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).handleActions(args27, new Environment(env), new utils.TemplateCall("none", args26), withcallsmapout, attrsmapout, out);
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).storeInputs(args25, new Environment(env), new utils.TemplateCall("none", args24), withcallsmapout, attrsmapout);
      }
      catch(NullPointerException npe)
      { }
    }
