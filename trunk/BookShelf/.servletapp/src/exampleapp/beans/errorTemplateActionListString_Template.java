...
{ 
  ...
  { 
    ...
    java.util.ArrayList<String> list21 = new java.util.ArrayList<String>(messages1);
    inForLoop = true;
    forLoopCounter++;
    int limit2 = 1000;
    int offset2 = 0;
    int removedcount2 = 0;
    Object[] array4 = list21.toArray();
    for(int i4 = 0; i4 < array4.length; i4++)
    { 
      String ve1 = (String)array4[i4];
      if(limit2 <= 0)
      { 
        list21.remove(i4 - removedcount2);
        removedcount2++;
      }
      limit2--;
    }
    int separatorindex2 = 0;
    Object[] array5 = list21.toArray();
