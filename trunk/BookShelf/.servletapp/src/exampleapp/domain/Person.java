...
{ 
  ...
  public void setParentsList(java.util.List<exampleapp.domain.Person> list110)
  { 
    setParents(new java.util.LinkedHashSet<exampleapp.domain.Person>(list110));
  }
  ...
  public void setChildrenList(java.util.List<exampleapp.domain.Person> list111)
  { 
    setChildren(new java.util.LinkedHashSet<exampleapp.domain.Person>(list111));
  }
