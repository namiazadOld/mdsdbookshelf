...
public class root_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        initialized = true;
        this.env = env;
        env.putTemplate("body", root_body_Template.class);
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("root_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "root()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "root()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    ident += "tcall9";
    ThreadLocalPage.get().enterTemplateContext("tcall9");
    try
    { 
      Object[] args71 = {};
      Object[] args70 = {};
      ...
      { 
        ...
        ((TemplateServlet)templatecalls.get(ident)).validateInputs(args71, new Environment(env), new utils.TemplateCall("none", args70), withcallsmapout, attrsmapout);
      }
    ...
    ident = "";
    ThreadLocalPage.get().leaveTemplateContextChecked("tcall9");
  }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).render(args77, new Environment(env), new utils.TemplateCall("none", args76), withcallsmapout, attrsmapout, out);
      }
      catch(NullPointerException npe)
      { }
    }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).handleActions(args75, new Environment(env), new utils.TemplateCall("none", args74), withcallsmapout, attrsmapout, out);
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).storeInputs(args73, new Environment(env), new utils.TemplateCall("none", args72), withcallsmapout, attrsmapout);
      }
      catch(NullPointerException npe)
      { }
    }
