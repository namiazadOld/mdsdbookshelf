...
{ 
  ...
  { 
    ...
    java.util.ArrayList<String> list24 = new java.util.ArrayList<String>(messages2);
    inForLoop = true;
    forLoopCounter++;
    int limit3 = 1000;
    int offset3 = 0;
    int removedcount3 = 0;
    Object[] array6 = list24.toArray();
    for(int i6 = 0; i6 < array6.length; i6++)
    { 
      String ve2 = (String)array6[i6];
      if(limit3 <= 0)
      { 
        list24.remove(i6 - removedcount3);
        removedcount3++;
      }
      limit3--;
    }
    int separatorindex3 = 0;
    Object[] array7 = list24.toArray();
