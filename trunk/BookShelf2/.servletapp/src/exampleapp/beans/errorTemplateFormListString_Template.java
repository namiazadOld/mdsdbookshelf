...
{ 
  ...
  { 
    ...
    java.util.ArrayList<String> list16 = new java.util.ArrayList<String>(messages0);
    inForLoop = true;
    forLoopCounter++;
    int limit1 = 1000;
    int offset1 = 0;
    int removedcount1 = 0;
    Object[] array2 = list16.toArray();
    for(int i2 = 0; i2 < array2.length; i2++)
    { 
      String ve0 = (String)array2[i2];
      if(limit1 <= 0)
      { 
        list16.remove(i2 - removedcount1);
        removedcount1++;
      }
      limit1--;
    }
    int separatorindex1 = 0;
    Object[] array3 = list16.toArray();
