...
public class validatedInput_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("validatedInput_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "validatedInput()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "validatedInput()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    { 
      ...
      if(ThreadLocalPage.get().templateSpans())
        outtemp.write("<span id=\"" + "validatedInput" + "\" class=\"scopediv " + "validatedInput" + "\">");
