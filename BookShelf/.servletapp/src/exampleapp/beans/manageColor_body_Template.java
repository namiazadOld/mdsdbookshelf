...
{ 
  ...
  { 
    ...
    java.util.List<exampleapp.domain.Color> list104 = hibSession.createCriteria(exampleapp.domain.Color.class).setCacheable(true).list();
    inForLoop = true;
    forLoopCounter++;
    int limit75 = 1000;
    int offset75 = 0;
    int removedcount75 = 0;
    Object[] array162 = list104.toArray();
    for(int i162 = 0; i162 < array162.length; i162++)
    { 
      exampleapp.domain.Color elem2 = (exampleapp.domain.Color)array162[i162];
      if(limit75 <= 0)
      { 
        list104.remove(i162 - removedcount75);
        removedcount75++;
      }
      limit75--;
    }
    int separatorindex75 = 0;
    Object[] array163 = list104.toArray();
    ...
    { 
      ...
      { 
        ident += (inForLoop ? forelementcounter : "") + ("form20" + uniqueid);
  ...
  { 
    ...
    ThreadLocalPage.get().commonContextsCheckEnter(out);
    out.print("<ul " + "" + ">");
    java.util.List<exampleapp.domain.Color> list109 = hibSession.createCriteria(exampleapp.domain.Color.class).setCacheable(true).list();
    inForLoop = true;
    forLoopCounter++;
    int limit79 = 1000;
    int offset79 = 0;
    int removedcount79 = 0;
    Object[] array170 = list109.toArray();
    for(int i170 = 0; i170 < array170.length; i170++)
    { 
      exampleapp.domain.Color elem2 = (exampleapp.domain.Color)array170[i170];
      if(limit79 <= 0)
      { 
        list109.remove(i170 - removedcount79);
        removedcount79++;
      }
      limit79--;
    }
    int separatorindex79 = 0;
    Object[] array171 = list109.toArray();
    ...
    { 
      ...
      ThreadLocalPage.get().commonContextsCheckEnter(out);
      ident = (inForLoop ? forelementcounter : "") + ("action12" + uniqueid + ("" + (elem2 != null ? elem2.getVersion() == 0 ? "_" : elem2.getId().toString() : "null")));
      ...
      { 
        ...
        java.util.ArrayList<String> list108 = new java.util.ArrayList<String>(messagesList68);
        inForLoop = true;
        forLoopCounter++;
        int limit78 = 1000;
        int offset78 = 0;
        int removedcount78 = 0;
        Object[] array168 = list108.toArray();
        for(int i168 = 0; i168 < array168.length; i168++)
        { 
          String ve1 = (String)array168[i168];
          if(limit78 <= 0)
          { 
            list108.remove(i168 - removedcount78);
            removedcount78++;
          }
          limit78--;
        }
        int separatorindex78 = 0;
        Object[] array169 = list108.toArray();
        ...
        { 
          ...
          { 
            ThreadLocalPage.get().commonContextsCheckEnter(out);
            out.print("<div " + ("style" + "='" + "clear:left; float:left; border: 1px solid #FF0000; margin-left: -5px; margin-top: 5px; margin-bottom: 5px; padding: 4px" + "' ") + " class=\"block\" >");
            java.util.ArrayList<String> list107 = new java.util.ArrayList<String>(messagesList67);
            inForLoop = true;
            forLoopCounter++;
            int limit77 = 1000;
            int offset77 = 0;
            int removedcount77 = 0;
            Object[] array166 = list107.toArray();
            for(int i166 = 0; i166 < array166.length; i166++)
            { 
              String ve1 = (String)array166[i166];
              if(limit77 <= 0)
              { 
                list107.remove(i166 - removedcount77);
                removedcount77++;
              }
              limit77--;
            }
            int separatorindex77 = 0;
            Object[] array167 = list107.toArray();
  ...
  { 
    ...
    boolean inForLoop = false;
    int forLoopCounter = 0;
    java.util.List<exampleapp.domain.Color> list106 = hibSession.createCriteria(exampleapp.domain.Color.class).setCacheable(true).list();
    inForLoop = true;
    forLoopCounter++;
    int limit76 = 1000;
    int offset76 = 0;
    int removedcount76 = 0;
    Object[] array164 = list106.toArray();
    for(int i164 = 0; i164 < array164.length; i164++)
    { 
      exampleapp.domain.Color elem2 = (exampleapp.domain.Color)array164[i164];
      if(limit76 <= 0)
      { 
        list106.remove(i164 - removedcount76);
        removedcount76++;
      }
      limit76--;
    }
    int separatorindex76 = 0;
    Object[] array165 = list106.toArray();
