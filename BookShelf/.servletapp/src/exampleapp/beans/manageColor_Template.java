...
public class manageColor_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        initialized = true;
        this.env = env;
        env.putTemplate("body", manageColor_body_Template.class);
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("manageColor_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "manageColor()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "manageColor()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    ident += "tcall8";
    ThreadLocalPage.get().enterTemplateContext("tcall8");
    try
    { 
      Object[] args63 = {};
      Object[] args62 = {};
      ...
      { 
        ...
        ((TemplateServlet)templatecalls.get(ident)).validateInputs(args63, new Environment(env), new utils.TemplateCall("none", args62), withcallsmapout, attrsmapout);
      }
    ...
    ident = "";
    ThreadLocalPage.get().leaveTemplateContextChecked("tcall8");
  }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).render(args69, new Environment(env), new utils.TemplateCall("none", args68), withcallsmapout, attrsmapout, out);
      }
      catch(NullPointerException npe)
      { }
    }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).handleActions(args67, new Environment(env), new utils.TemplateCall("none", args66), withcallsmapout, attrsmapout, out);
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).storeInputs(args65, new Environment(env), new utils.TemplateCall("none", args64), withcallsmapout, attrsmapout);
      }
      catch(NullPointerException npe)
      { }
    }
