...
public class EditColorPage extends PageServlet 
{ 
  ...
  editColor_Template templateservlet = new editColor_Template();
  ...
  private String arg10_id;

  public void setArg10_id(String v)
  { 
    this.arg10_id = v;
  }

  public String getArg10_id()
  { 
    return this.arg10_id;
  }
  ...
  { 
    combinedparams.append("arg" + "=" + utils.HTMLFilter.filter(arg10.getNaturalId().toString()) + "&");
  }

  public void hiddenParams(java.lang.StringBuffer combinedparams)
  { 
    combinedparams.append("<input type=\"hidden\" name=\"" + "arg" + "\" value=\"" + utils.HTMLFilter.filter(arg10.getNaturalId().toString()) + "\" />");
  }
  ...
  { 
    if(arg10_id != null)
    { 
      arg10_id = utils.URLFilter.unfilter(arg10_id.toString());
      List<exampleapp.domain.Color> results = hibSession.createCriteria(exampleapp.domain.Color.class).add(org.hibernate.criterion.Restrictions.naturalId().set("_name", arg10_id)).list();
      if(results.size() == 0)
      { 
        System.out.println("No entity with this identity found: " + arg10_id);
        throw new RuntimeException("No entity with this identity found: " + arg10_id);
      }
      else
        if(results.size() > 1)
        { 
          System.out.println("Multiple entities with this identity found: " + arg10_id);
          throw new RuntimeException("Multiple entities with this identity found: " + arg10_id);
        }
        else
        { 
          arg10 = results.get(0);
