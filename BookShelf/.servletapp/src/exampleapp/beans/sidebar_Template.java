...
public class sidebar_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("sidebar_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "sidebar()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "sidebar()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    { 
      ...
      if(ThreadLocalPage.get().templateSpans())
        outtemp.write("<span id=\"" + "sidebar" + "\" class=\"scopediv " + "sidebar" + "\">");
