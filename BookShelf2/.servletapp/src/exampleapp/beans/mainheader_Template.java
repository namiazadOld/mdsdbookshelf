...
public class mainheader_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("mainheader_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "mainheader()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "mainheader()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    { 
      ...
      if(ThreadLocalPage.get().templateSpans())
        outtemp.write("<span id=\"" + "mainheader" + "\" class=\"scopediv " + "mainheader" + "\">");
  ...
  { 
    ...
    try
    { 
      tmpstring175 = ThreadLocalPage.get().isRawoutput() ? String.valueOf("/images/logosmall.png") : utils.HTMLFilter.filter(String.valueOf("/images/logosmall.png"));
    }
