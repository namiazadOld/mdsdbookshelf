...
public class pagenotfound_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("pagenotfound_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "pagenotfound()" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "pagenotfound()" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  { 
    ...
    try
    { 
      tmpstring1 = ThreadLocalPage.get().isRawoutput() ? String.valueOf("404 Not Found") : utils.HTMLFilter.filter(String.valueOf("404 Not Found"));
    }
    catch(NullPointerException npe)
    { 
      tmpstring1 = "";
    }
    out.print(tmpstring1);
