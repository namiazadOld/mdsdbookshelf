...
{ 
  ...
  { 
    ...
    try
    { 
      tmpstring176 = ThreadLocalPage.get().isRawoutput() ? String.valueOf("Home") : utils.HTMLFilter.filter(String.valueOf("Home"));
    }
    ...
    try
    { 
      tmpstring177 = ThreadLocalPage.get().isRawoutput() ? String.valueOf("Manage Person") : utils.HTMLFilter.filter(String.valueOf("Manage Person"));
    }
    catch(NullPointerException npe)
    { 
      tmpstring177 = "";
