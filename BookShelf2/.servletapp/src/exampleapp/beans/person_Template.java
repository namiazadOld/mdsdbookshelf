...
public class person_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        initialized = true;
        this.env = env;
        env.putTemplate("body", person_body_Template.class);
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("person_Template", "" + (arg0 != null ? arg0.getVersion() == 0 ? "_" : arg0.getId().toString() : "null"), ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
        ...
        { 
          ...
          utils.Warning.warn("Validation failed in initialization of " + "person(arg : Person)" + ": " + ve.getErrorMessage());
        ...
        { 
          ...
          { 
            ...
            utils.Warning.warn("Validation failed in initialization of " + "person(arg : Person)" + ": " + vex.getErrorMessage());
          }
          ThreadLocalPage.get().setValidated(false);
          skipThisTemplate = true;
        }
  ...
  private exampleapp.domain.Person arg0 = null;
  ...
  { 
    ...
    ident += "tcall2";
    ThreadLocalPage.get().enterTemplateContext("tcall2");
    try
    { 
      Object[] args15 = {};
      Object[] args14 = {};
      ...
      { 
        ...
        ((TemplateServlet)templatecalls.get(ident)).validateInputs(args15, new Environment(env), new utils.TemplateCall("none", args14), withcallsmapout, attrsmapout);
      }
    ...
    ident = "";
    ThreadLocalPage.get().leaveTemplateContextChecked("tcall2");
  }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).render(args21, new Environment(env), new utils.TemplateCall("none", args20), withcallsmapout, attrsmapout, out);
      }
      catch(NullPointerException npe)
      { }
    }
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).handleActions(args19, new Environment(env), new utils.TemplateCall("none", args18), withcallsmapout, attrsmapout, out);
  ...
  { 
    ...
    { 
      ...
      { 
        withcallsmapout = withcallsmap;
        Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
        ((TemplateServlet)templatecalls.get(ident)).storeInputs(args17, new Environment(env), new utils.TemplateCall("none", args16), withcallsmapout, attrsmapout);
      }
      catch(NullPointerException npe)
      { }
    }
