...
public class root_body_Template  implements TemplateServlet
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        ...
        { 
          storeArguments(args);
          this.uniqueid = Encoders.encodeTemplateId("root_body_Template", "", ThreadLocalPage.get().getTemplateContextString());
          initialize();
          initializeLocalVars();
          initializePassOn();
          initActions();
  ...
  { 
    ...
    try
    { 
      tmpstring165 = ThreadLocalPage.get().isRawoutput() ? String.valueOf("Hello world!") : utils.HTMLFilter.filter(String.valueOf("Hello world!"));
    }
    catch(NullPointerException npe)
    { 
      tmpstring165 = "";
    }
    out.print(tmpstring165);
